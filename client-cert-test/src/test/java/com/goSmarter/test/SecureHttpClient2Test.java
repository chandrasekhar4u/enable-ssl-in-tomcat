...
public class SecureHttpClient2Test {
	...
	public void testMainPage() throws Exception {
		...
		method.setURI(new URI("https://localhost:8443/client2/index.jsp", false));
	...
	public void testSecurePage() throws Exception {
		HttpClient client = new HttpClient();
		GetMethod method = new GetMethod();
		method.setURI(new URI("https://localhost:8443/client2/secure/index.jsp",
				false));
		client.executeMethod(method);
	...
	public void testSecurePageNegativeCase() throws Exception {
		...
		HttpGet lMethod = new HttpGet(
				"https://localhost:8443/client2/secure/index.jsp");
